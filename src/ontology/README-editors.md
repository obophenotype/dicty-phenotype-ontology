These notes are for the EDITORS of ddpheno
...
Make sure you have an ID range in the [idranges file](ddpheno-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [ddpheno-edit.owl](ddpheno-edit.owl)

** DO NOT EDIT ddpheno.obo OR ddpheno.owl in the top level directory **

[../../ddpheno.owl](../../ddpheno.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/obophenotype/dicty-phenotype-ontology) for details.
 ...
 * [ddpheno-idranges.owl](ddpheno-idranges.owl)
...
There are two ways to include new classes in an import module
 ...
 2. Add to the imports/ddpheno_terms.txt file
...
Note: the ddpheno_terms.txt file may include 'starter' classes seeded from
...
This generates derived files such as ddpheno.owl and ddpheno.obo and places
 ...
 * https://github.com/obophenotype/dicty-phenotype-ontology/releases
 * https://github.com/obophenotype/dicty-phenotype-ontology/releases/new
...
what is in the `owl:versionIRI` of the derived ddpheno.owl (`data-version` in
ddpheno.obo). This will be today's date.
 ...
 * http://purl.obolibrary.org/obo/ddpheno.owl <-- current ontology PURL
 * http://purl.obolibrary.org/obo/ddpheno/releases/YYYY-MM-DD.owl <-- change to the release you just made

For questions on this contact Chris Mungall or email obo-admin AT obofoundry.org

# Travis Continuous Integration System

Check the build status here: [![Build Status](https://travis-ci.org/obophenotype/dicty-phenotype-ontology.svg?branch=master)](https://travis-ci.org/obophenotype/dicty-phenotype-ontology)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/obophenotype](https://travis-ci.org/profile/obophenotype)
 2. click the "Sync account" button
 3. Click the tick symbol next to dicty-phenotype-ontology
